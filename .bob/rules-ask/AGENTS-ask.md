...
4. Do not propose a design in this phase, even if the user's message seems complete. End with: "Waiting for your answers before the Design phase."

If the user's message contains "propose first and wait for my approval" or similar, treat it as confirmation that the next phase needs an explicit go from them.
