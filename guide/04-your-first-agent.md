...
4. The closing line, "Waiting for your answers before the Design phase." That is the Discover rules speaking, and it is also the check that they loaded: a design at this point, instead of that line, means they did not, and the checklist in section 2.7 is where to look.
